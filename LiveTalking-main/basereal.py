...
from ttsreal import EdgeTTS,SovitsTTS,XTTS,CosyVoiceTTS,FishTTS,TencentTTS,DoubaoTTS,IndexTTS2,AzureTTS,BaiduTTS,SiliconFlowTTS
...
class BaseReal:
    def __init__(self, opt):
        ...
        if opt.tts == "edgetts":
            ...
            self.tts = BaiduTTS(opt,self)
        elif opt.tts == "siliconflow":
            self.tts = SiliconFlowTTS(opt,self)
