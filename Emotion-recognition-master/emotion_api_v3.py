...
def load_model_and_detector():
    ...
    try:
        ...
        # 加载预训练模型
        model_path = r'D:\AAAfuwuwaibao\code\Emotion-recognition-master\models\_mini_XCEPTION.102-0.66.hdf5'
        ...
        # 加载人脸检测器
        cascade_path = r'D:\AAAfuwuwaibao\code\Emotion-recognition-master\haarcascade_files\haarcascade_frontalface_default.xml'
...
if __name__ == '__main__':
    if load_model_and_detector():
        logger.info("启动优化的情绪检测API服务 v3.0...")
